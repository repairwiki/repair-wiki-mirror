---
title: "How To Fix iPhone 7 That Has No Backlight or Dark Spot On Screen"
pageid: 1442
revid: 3145
kind: repair_guide
source: "https://repair.wiki/w/How_To_Fix_iPhone_7_That_Has_No_Backlight_or_Dark_Spot_On_Screen"
history: "https://repair.wiki/index.php?title=How_To_Fix_iPhone_7_That_Has_No_Backlight_or_Dark_Spot_On_Screen&action=history"
permalink: "https://repair.wiki/index.php?oldid=3145"
last_edited: "2024-01-22T08:44:19Z"
contributors:
  - "VCCBoardRepairs"
anonymous_edits: 0
categories:
...
# How To Fix iPhone 7 That Has No Backlight or Dark Spot On Screen

## Problem description
iPhone 7 with a dark screen, where you can barely see anything on the screen but you can see an image.

Or if you have a dark spot on the corner of the screen
![456x456px](images/f/ff/IP7_No_Backlight.png)![Example image (Figure 1) -- No image yet. Help expand this page by uploading it!](images/3/30/Placeholder_image.jpg)
## Symptoms
- Screen is dark
...
- Check USB Charging Current. If an iPhone shows proper charging current (1A via USB or more), then most likely the device is alive.
